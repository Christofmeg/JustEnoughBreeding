...
public class Utils {
    ...
    public static BreedingRecipe createBreedingRecipe(EntityType<?> entityType, Ingredient combinedIngredient, Item spawnEggItem, Boolean needsToBeTamed, List<Ingredient> resultItemStacks, Boolean animalTrusting, Ingredient combinedExtraIngredient) {
    ...
    public static void renderEntity(PoseStack stack, double mouseX, LivingEntity currentLivingEntity) {
        ...
        stack.mulPose(Vector3f.ZP.rotationDegrees(180.0F)); // Rotate the entity 180 degrees on the X-axis
