...
public class JustEnoughBreeding {
    ...
    public JustEnoughBreeding() {
        ...
        ModLoadingContext.get().registerExtensionPoint(IExtensionPoint.DisplayTest.class, () -> new IExtensionPoint.DisplayTest.DisplayTest(()-> FMLNetworkConstants.IGNORESERVERONLY, (remote, isServer)-> true));
