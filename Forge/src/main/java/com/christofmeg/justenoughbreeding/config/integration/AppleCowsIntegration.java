...
public class AppleCowsIntegration {
    ...
    private static final String MOD = "apple_cows";

    public static class General {
        private static final String WHEAT = "minecraft:wheat";
        private static final String GOLDEN_WHEAT = "apple_cows:golden_wheat";
        private static final String ENCHANTED_GOLDEN_WHEAT = "apple_cows:enchanted_golden_wheat";
        ...
        public General(ForgeConfigSpec.Builder builder) {
            ...
            addAnimal("apple_cow", WHEAT);
            addAnimal("golden_apple_cow", GOLDEN_WHEAT);
            addAnimal("enchanted_golden_apple_cow", ENCHANTED_GOLDEN_WHEAT);
