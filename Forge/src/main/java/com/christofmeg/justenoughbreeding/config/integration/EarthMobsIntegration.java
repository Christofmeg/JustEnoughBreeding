...
public class EarthMobsIntegration {
    ...
    final String MOD = "earthmobsmod"; //TODO BREEDING TEMPER TAMING TRUSTING
    ...
    public EarthMobsIntegration(ForgeConfigSpec.Builder builder) {
        ...
        addAnimal("cluck_shroom", CommonStrings.SEEDS);
        addAnimal("duck", CommonStrings.SEEDS);
        addAnimal("fancy_chicken", CommonStrings.SEEDS);
        addAnimal("wooly_cow", CommonStrings.WHEAT);
        addAnimal("umbra_cow", CommonStrings.WHEAT);
        addAnimal("moobloom", CommonStrings.WHEAT);
        addAnimal("moolip", CommonStrings.WHEAT);
        addAnimal("horned_sheep", CommonStrings.WHEAT);
        addAnimal("hyper_rabbit", CommonStrings.DANDELION_CARROTS);
        addAnimal("jumbo_rabbit", CommonStrings.DANDELION_CARROTS);
        addAnimal("zombified_pig", CommonStrings.VEGETABLES);
        addTamableOnly("skelton_wolf", CommonStrings.BONE_FLESH);
        addTamableOnly("wither_skelton_wolf", CommonStrings.BONE_FLESH);
        ...
        for (String tamable : tamableOnly) {
            if(tamingIngredients.get(tamable) != null && tamingChance.get(tamable) != null) {
                ...
                ForgeConfigSpec.ConfigValue<String> animalSpawnEgg = builder.push(tamable).define(tamable + "SpawnEgg", MOD + ":" + tamable + "_spawn_egg");
                CommonConstants.spawnEggConfigs.put(MOD + "_" + tamable, animalSpawnEgg); //TODO move all into IF statement
                builder.pop();
            }
        }
        builder.pop(2);
