...
public class TwilightForestIntegration {
    ...
    final String MOD = "twilightforest"; //TODO BREEDING TEMPER TAMING TRUSTING
    ...
    public TwilightForestIntegration(ForgeConfigSpec.Builder builder) {
        ...
        addAnimal("bighorn_sheep", CommonStrings.WHEAT);
        addAnimal("boar", CommonStrings.VEGETABLES);
        addAnimal("deer", CommonStrings.WHEAT);
        addAnimal("dwarf_rabbit", CommonStrings.DANDELION_CARROTS);
        addAnimal("penguin", CommonStrings.COD);
