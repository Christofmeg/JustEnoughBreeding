...
/*-----------------------------------------------------------------------------------------*/
    ...
    public static void addAnimalNames(List<String> animalNames, Map<String, String> ingredients, String MOD, Map<String, Integer> breedingCooldown, Map<String, Boolean> needsToBeTamed, Map<String, String> resultEggs, Map<String, Integer> eggsAmountMin, Map<String, Integer> eggsAmountMax) {
    ...
    public static void addAnimalNames(List<String> animalNames, Map<String, String> ingredients, Map<String, String> extraIngredients, String MOD, Map<String, Integer> breedingCooldown, Map<String, String> resultEggs, Map<String, Integer> eggsAmountMin, Map<String, Integer> eggsAmountMax) {
    ...
    public static void addAnimalNames(List<String> animalNames, Map<String, String> ingredients, Map<String, String> extraIngredients, String MOD, Map<String, Integer> breedingCooldown, Map<String, Boolean> needsToBeTamed, Map<String, String> resultEggs, Map<String, Integer> eggsAmountMin, Map<String, Integer> eggsAmountMax) {
    ...
    public static void addAnimalNames(List<String> animalNames, Map<String, String> ingredients, Map<String, String> extraIngredients, String MOD, Map<String, Integer> breedingCooldown, Map<String, Boolean> needsToBeTamed, String spawnEggString, boolean addStringBeforeAnimalName, Map<String, String> resultEggs, Map<String, Integer> eggsAmountMin, Map<String, Integer> eggsAmountMax) {
    ...
    public static void addAnimalNames(List<String> animalNames, Map<String, String> ingredients, Map<String, String> spawnEggItems, Map<String, String> entitiesFromNames, String MOD, Map<String, Integer> breedingCooldown, Map<String, String> resultEggs, Map<String, Integer> eggsAmountMin, Map<String, Integer> eggsAmountMax) {
    ...
    public static void addAnimalNames(List<String> animalNames, Map<String, String> ingredients, Map<String, String> spawnEggItems, Map<String, String> entitiesFromNames, String MOD, Map<String, Integer> breedingCooldown, Map<String, Boolean> needsToBeTamed, Map<String, String> resultEggs, Map<String, Integer> eggsAmountMin, Map<String, Integer> eggsAmountMax) {
    ...
    public static void addAnimalNames(List<String> animalNames, Map<String, String> ingredients, Map<String, String> extraIngredients, Map<String, String> spawnEggItems, Map<String, String> entitiesFromNames, String MOD, Map<String, Integer> breedingCooldown, Map<String, String> resultEggs, Map<String, Integer> eggsAmountMin, Map<String, Integer> eggsAmountMax) {
    ...
    public static void addAnimalNames(List<String> animalNames, Map<String, String> ingredients, Map<String, String> extraIngredients, Map<String, String> spawnEggItems, Map<String, String> entitiesFromNames, String MOD, Map<String, Integer> breedingCooldown, Map<String, Boolean> needsToBeTamed, Map<String, String> resultEggs, Map<String, Integer> eggsAmountMin, Map<String, Integer> eggsAmountMax) {
    ...
    public static void addAnimalNames(List<String> animalNames, Map<String, String> ingredients, Map<String, String> extraIngredients, String MOD, Map<String, Integer> breedingCooldown, Map<String, Boolean> needsToBeTamed, String customSpawnEggString) {
    ...
    public static void addAnimalNames(List<String> animalNames, Map<String, String> ingredients, Map<String, String> extraIngredients, Map<String, String> spawnEggItems, Map<String, String> entitiesFromNames, String MOD, Map<String, Integer> breedingCooldown, Map<String, Boolean> needsToBeTamed) {
    ...
    public static void addAnimalNames(List<String> animalNames, Map<String, String> ingredients, Map<String, String> extraIngredients, Map<String, String> spawnEggItems, Map<String, String> entitiesFromNames, String MOD, Map<String, Integer> breedingCooldown, Map<String, Boolean> needsToBeTamed, String customSpawnEggString, String spawnEggString, boolean addStringBeforeAnimalName) {
        for (String animal : animalNames) {
 ...
 */
    ...
    public static void addTamableAnimalNames(List<String> tamableOnly, Map<String, String> tamingIngredients, Map<String, Integer> tamingChance, String MOD, String spawnEggString, boolean addStringBeforeAnimalName) {
        addTamableAnimalNames(tamableOnly, tamingIngredients, tamingChance, MOD, spawnEggString, addStringBeforeAnimalName, null);
    }

    public static void addTamableAnimalNames(List<String> tamableOnly, Map<String, String> tamingIngredients, Map<String, Integer> tamingChance, String MOD, String customSpawnEggString, Map<String, String> extraIngredients) {
    ...
    public static void addTamableAnimalNames(List<String> tamableOnly, Map<String, String> tamingIngredients, Map<String, Integer> tamingChance, String MOD, String spawnEggString, boolean addStringBeforeAnimalName, Map<String, String> extraIngredients) {
    ...
    public static void addTamableAnimalNames(List<String> tamableOnly, Map<String, String> tamingIngredients, Map<String, Integer> tamingChance, String MOD, Map<String, String> spawnEggItems, Map<String, String> entitiesFromNames) {
        addTamableAnimalNames(tamableOnly, tamingIngredients, tamingChance, MOD, null, spawnEggItems, entitiesFromNames);
    }

    public static void addTamableAnimalNames(List<String> tamableOnly, Map<String, String> tamingIngredients, Map<String, Integer> tamingChance, String MOD, Map<String, String> extraIngredients, Map<String, String> spawnEggItems, Map<String, String> entitiesFromNames) {
    ...
    public static void addTamableAnimalNames(List<String> tamableOnly, Map<String, String> tamingIngredients, Map<String, Integer> tamingChance, String MOD, String customSpawnEggString, String spawnEggString, boolean addStringBeforeAnimalName, Map<String, String> extraIngredients, Map<String, String> spawnEggItems, Map<String, String> entitiesFromNames) {
 ...
 */
    ...
    public static void addTrustingAnimalNames(List<String> trustingOnly, Map<String, String> trustingIngredients, Map<String, Integer> trustingChance, String MOD, Map<String, String> spawnEggItems, Map<String, String> entitiesFromNames) {
