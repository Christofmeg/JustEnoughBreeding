...
public class JEBConfig {
    ...
    public static class General {
        ...
        private static final String MEAT = FabricUtils.getEdibleMeatItemNames(true); //TODO Foodproperties.isMeat() to other mods
        ...
        public General(ForgeConfigSpec.Builder builder) {
            ...
            if (FabricLoader.getInstance().isModLoaded("aqcaracal")) {
                @SuppressWarnings("unused")
