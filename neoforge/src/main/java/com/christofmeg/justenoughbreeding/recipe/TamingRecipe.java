...
public record TamingRecipe(
    ...
    @Override public @NonNull RecipeSerializer<? extends @NotNull Recipe<@NotNull CraftingInput>> getSerializer() { return JustEnoughBreeding.TAMING_PROVIDER_SERIALIZER.get(); }
    @Override public @NonNull RecipeType<? extends @NotNull Recipe<@NotNull CraftingInput>> getType() { return JustEnoughBreeding.TAMING_PROVIDER_TYPE.get(); }
