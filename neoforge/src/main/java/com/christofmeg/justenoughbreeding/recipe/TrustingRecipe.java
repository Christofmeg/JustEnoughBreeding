...
public record TrustingRecipe(EntityType<?> entityType, @NotNull Ingredient inputs, @NotNull Ingredient spawnEggs, @NotNull Ingredient extraInputs, String mod, String inputEntity, @Nullable CompoundTag inputEntityNbt) implements Recipe<CraftingInput> {
    ...
    @Override public @NotNull RecipeSerializer<?> getSerializer() { return JustEnoughBreeding.TRUSTING_PROVIDER_SERIALIZER.get(); }
    @Override public @NotNull RecipeType<?> getType() { return JustEnoughBreeding.TRUSTING_PROVIDER_TYPE.get(); }
