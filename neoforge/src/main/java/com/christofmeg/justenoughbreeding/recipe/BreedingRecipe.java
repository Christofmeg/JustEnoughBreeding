...
public record BreedingRecipe(EntityType<?> entityType, @NotNull Ingredient inputs, @NotNull Ingredient spawnEgg, @Nullable Boolean tamed, @NotNull Ingredient outputs, @NotNull Ingredient extraInputs, @Nullable Boolean trusting, String mod, String inputEntity, @Nullable CompoundTag inputEntityNbt) implements Recipe<CraftingInput> {
