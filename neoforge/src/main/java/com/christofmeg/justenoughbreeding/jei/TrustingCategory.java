...
public class TrustingCategory extends AbstractRecipeCategory<TrustingRecipe> {
    ...
    public static final IRecipeType<TrustingRecipe> TYPE = IRecipeType.create(Identifier.fromNamespaceAndPath(CommonConstants.MOD_ID, "trusting"), TrustingRecipe.class);
