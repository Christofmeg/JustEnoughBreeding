...
public class BreedingCategoryEMI implements EmiRecipe {
    ...
    public static EmiRecipeCategory TYPE = new EmiRecipeCategory(
            ...
            EmiStack.of(Items.WHEAT), EMIPlugin.simplifiedRenderer(u, v), EmiRecipeSorting.none());
    ...
    public void addWidgets(WidgetHolder widgets) {
        ...
        widgets.addSlot(EmiIngredient.of(recipe.resultItemStack), 126, 44).output(true).recipeContext(this);
