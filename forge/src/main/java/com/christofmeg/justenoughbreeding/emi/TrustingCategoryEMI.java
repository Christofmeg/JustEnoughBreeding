...
public class TrustingCategoryEMI implements EmiRecipe {
    ...
    public static class Builder {
        ...
        private TrustingRecipe trustingRecipe;

        private Builder() {
        }

        public EmiRecipe build() {
            return new TrustingCategoryEMI(this, trustingRecipe);
        }
        ...
        public Builder trustingRecipe(TrustingRecipe recipe) {
            this.trustingRecipe = recipe;
            return this;
        }
