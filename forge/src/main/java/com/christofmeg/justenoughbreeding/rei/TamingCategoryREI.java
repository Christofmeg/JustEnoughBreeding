...
public class TamingCategoryREI implements DisplayCategory<TamingDisplay> {

    public static final CategoryIdentifier<TamingDisplay> TYPE =
            CategoryIdentifier.of(CommonConstants.MOD_ID, "taming");

    @Override
    public CategoryIdentifier<? extends TamingDisplay> getCategoryIdentifier() {
        return TYPE;
    }

    @Override
    public Component getTitle() {
        return Component.translatable("translation.justenoughbreeding.taming");
    }

    @Override
    public Renderer getIcon() {
        return EntryStacks.of(Items.BONE);
    }
    ...
    public List<Widget> setupDisplay(TamingDisplay display, Rectangle bounds) {
        ...
        for (ItemStack stack : display.tamingRecipe.spawnEgg.getItems()) {
        ...
        TamingRecipe recipe = display.tamingRecipe;
