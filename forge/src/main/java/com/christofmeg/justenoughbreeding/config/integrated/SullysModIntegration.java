...
public class SullysModIntegration {

    static final String MOD = "sullysmod";
    ...
    public static void init() {
        CommonUtils.addAnimalEggLaying("tortoise", CommonStrings.TORTOISE_FOOD_TAG, "sullysmod:tortoise_egg", 4, animalNames, ingredients, breedingCooldown, resultEggs, eggsAmountMin, eggsAmountMax);
