...
public record TamingRecipe(
    ...
    @Override public @NonNull RecipeSerializer<? extends Recipe<CraftingInput>> getSerializer() { return JustEnoughBreeding.TAMING_PROVIDER_SERIALIZER; }
    @Override public @NonNull RecipeType<? extends Recipe<CraftingInput>> getType() { return JustEnoughBreeding.TAMING_PROVIDER_TYPE; }
