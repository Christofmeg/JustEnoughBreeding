...
public record TemperRecipe(
    ...
    @Override public @NonNull RecipeSerializer<? extends @NotNull Recipe<@NotNull CraftingInput>> getSerializer() { return JustEnoughBreeding.TEMPER_PROVIDER_SERIALIZER; }
    @Override public @NonNull RecipeType<? extends @NotNull Recipe<@NotNull CraftingInput>> getType() { return JustEnoughBreeding.TEMPER_PROVIDER_TYPE; }
